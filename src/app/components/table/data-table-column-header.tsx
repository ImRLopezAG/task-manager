    ...
    <div className={cn('flex items-center space-x-2', className)}>
      <DM.DropdownMenu>
        ...
        <DM.DropdownMenuContent align='start'>
          <DM.DropdownMenuItem onClick={() => { column.toggleSorting(false) }}>
            <ArrowUpIcon className='mr-2 h-3.5 w-3.5 text-muted-foreground/70' />
            Asc
          </DM.DropdownMenuItem>
          <DM.DropdownMenuItem onClick={() => { column.toggleSorting(true) }}>
            <ArrowDownIcon className='mr-2 h-3.5 w-3.5 text-muted-foreground/70' />
            Desc
          </DM.DropdownMenuItem>
          <DM.DropdownMenuSeparator />
          <DM.DropdownMenuItem onClick={() => { column.toggleVisibility(false) }}>
